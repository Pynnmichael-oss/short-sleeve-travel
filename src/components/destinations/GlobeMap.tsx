...
const DESTINATIONS = [
  {
    coordinates: [-72.9167, -50.9423] as [number, number],
  ...
  {
    coordinates: [-96.7266, 17.0732] as [number, number],
    name: 'Culture, Mezcal & Mountains',
  ...
  {
    coordinates: [-25.4756, 37.7412] as [number, number],
    name: 'Atlantic Wild',
